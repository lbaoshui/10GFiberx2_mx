	ddr_rdreq_cmdfifo u0 (
		.data    (_connected_to_data_),    //   input,  width = 35,  fifo_input.datain
		...
		.q       (_connected_to_q_),       //  output,  width = 35, fifo_output.dataout
		.rdusedw (_connected_to_rdusedw_), //  output,   width = 5,            .rdusedw
		.wrusedw (_connected_to_wrusedw_), //  output,   width = 5,            .wrusedw
