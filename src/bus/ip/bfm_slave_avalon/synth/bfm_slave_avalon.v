...
module bfm_slave_avalon #(
	...
	altera_avalon_mm_slave_bfm #(
		...
		.avs_writedata            (avs_writedata),     //   input,  width = 512,        s0.writedata
		.avs_burstcount           (avs_burstcount),    //   input,    width = 7,          .burstcount
		.avs_readdata             (avs_readdata),      //  output,  width = 512,          .readdata
		.avs_address              (avs_address),       //   input,   width = 23,          .address
		...
		.avs_byteenable           (avs_byteenable),    //   input,   width = 64,          .byteenable
