module bfm_slave_avalon #(
		parameter AV_ADDRESS_W               = 23,
		parameter AV_SYMBOL_W                = 8,
		parameter AV_NUMSYMBOLS              = 64,
		parameter AV_BURSTCOUNT_W            = 7,
		...
		input  wire [511:0] avs_writedata,     //        s0.writedata
		input  wire [6:0]   avs_burstcount,    //          .burstcount
		output wire [511:0] avs_readdata,      //          .readdata
		input  wire [22:0]  avs_address,       //          .address
		output wire         avs_waitrequest,   //          .waitrequest
		input  wire         avs_write,         //          .write
		input  wire         avs_read,          //          .read
		input  wire [63:0]  avs_byteenable,    //          .byteenable
