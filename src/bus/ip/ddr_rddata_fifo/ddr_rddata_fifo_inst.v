	ddr_rddata_fifo u0 (
		.data    (_connected_to_data_),    //   input,  width = 320,  fifo_input.datain
		...
		.q       (_connected_to_q_),       //  output,  width = 320, fifo_output.dataout
		.rdusedw (_connected_to_rdusedw_), //  output,   width = 10,            .rdusedw
		.wrusedw (_connected_to_wrusedw_), //  output,   width = 10,            .wrusedw
