	up_data_dpram_8x4096 u0 (
		.data_a    (_connected_to_data_a_),    //   input,   width = 8,    data_a.datain_a
		.q_a       (_connected_to_q_a_),       //  output,   width = 8,       q_a.dataout_a
		.data_b    (_connected_to_data_b_),    //   input,   width = 8,    data_b.datain_b
		.q_b       (_connected_to_q_b_),       //  output,   width = 8,       q_b.dataout_b
