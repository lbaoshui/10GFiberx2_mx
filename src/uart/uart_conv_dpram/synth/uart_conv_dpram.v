...
module uart_conv_dpram (
	...
	uart_conv_dpram_ram_2port_181_eb7gdtq ram_2port_0 (
		.data_a    (data_a),    //   input,  width = 64,    data_a.datain_a
		.q_a       (q_a),       //  output,  width = 64,       q_a.dataout_a
		.data_b    (data_b),    //   input,   width = 8,    data_b.datain_b
		.q_b       (q_b),       //  output,   width = 8,       q_b.dataout_b
		.address_a (address_a), //   input,   width = 9, address_a.address_a
