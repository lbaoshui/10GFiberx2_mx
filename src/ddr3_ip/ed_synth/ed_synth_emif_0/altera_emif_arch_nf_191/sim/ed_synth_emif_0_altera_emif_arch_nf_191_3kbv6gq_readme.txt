...
------------------------
   ...
   handbook chapter on Arria 10 DDR3 External Memory Interface.
...
----------------------
   ...
   The current memory interface occupies 2 banks.
   ...
   Logical bank 0 (address/command bank):
   --------------------------------------------
   
      Address/command pinout scheme  : DDR3 Scheme 2: Component/UDIMM/SODIMM
...
---------------------------------------------------
   ...
   mem_a                          13      output      Address
   mem_ba                         3       output      Bank address
   ...
   mem_we_n                       1       output      WE command
   mem_ras_n                      1       output      RAS command
   mem_cas_n                      1       output      CAS command
   mem_dqs                        5       bidir       Data strobe
   mem_dqs_n                      5       bidir       Data strobe (negative leg)
   mem_dq                         40      bidir       Read/write data
   mem_dm                         5       output      Write data mask
...
----------------------------------------------------
   ...
   amm_address_0                  23      input       Address for the read/write request
   amm_readdata_0                 320     output      Read data
   amm_writedata_0                320     input       Write data
   amm_burstcount_0               7       input       Number of transfers in each read/write burst
   amm_byteenable_0               40      input       Byte-enable for write data
   ...
   Interface properties:
      ...
      SYMBOL_WIDTH                  : 8
      SYMBOLS_PER_WORD              : 40
      BYTE_ENABLE_WIDTH             : 40
      USE_BYTE_ENABLE               : true
      WORD_ADDRESS_WIDTH            : 23
      SYMBOL_ADDRESS_WIDTH          : 29
      BURST_COUNT_WIDTH             : 7
...
--------------------
   ...
   SYS_INFO_DEVICE                                   : 10AX027H4F34E3SG
   ...
   TRAIT_IOBANK_REVISION                             : 
   PROTOCOL_ENUM                                     : PROTOCOL_DDR3
   IS_ED_SLAVE                                       : false
   INTERNAL_TESTING_MODE                             : false
   CAL_DEBUG_CLOCK_FREQUENCY                         : 50000000
   SYS_INFO_UNIQUE_ID                                : ed_synth_emif_0_emif_0
   PREV_PROTOCOL_ENUM                                : PROTOCOL_DDR3
   PHY_FPGA_SPEEDGRADE_GUI                           : E3 (Production) - change device under 'View'->'Device Family'
   PHY_TARGET_SPEEDGRADE                             : E3
   ...
   PHY_MEM_CLK_FREQ_MHZ                              : 933.0
   PHY_REF_CLK_FREQ_MHZ                              : 116.625
   PHY_REF_CLK_JITTER_PS                             : 10.0
   PHY_DLL_CORE_UPDN_EN                              : true
   ...
   PHY_AC_IO_STD_ENUM                                : IO_STD_SSTL_15_C1
   PHY_CK_IO_STD_ENUM                                : IO_STD_SSTL_15_C1
   PHY_DATA_IO_STD_ENUM                              : IO_STD_SSTL_15
   PHY_AC_MODE_ENUM                                  : CURRENT_ST_12
   PHY_CK_MODE_ENUM                                  : CURRENT_ST_12
   PHY_AC_DEEMPHASIS_ENUM                            : DEEMPHASIS_MODE_INVALID
   PHY_CK_DEEMPHASIS_ENUM                            : DEEMPHASIS_MODE_INVALID
   PHY_DATA_OUT_DEEMPHASIS_ENUM                      : DEEMPHASIS_MODE_INVALID
   PHY_DATA_OUT_SLEW_RATE_ENUM                       : 
   PHY_DATA_OUT_MODE_ENUM                            : OUT_OCT_34_CAL
   PHY_MIMIC_HPS_EMIF                                : false
   PLL_ADD_EXTRA_CLKS                                : false
   PLL_USER_NUM_OF_EXTRA_CLKS                        : 1
   ...
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_5               : 233.25
   ...
   PHY_DDR3_USER_AC_DEEMPHASIS_ENUM                  : unset
   ...
   PHY_DDR3_USER_CK_DEEMPHASIS_ENUM                  : unset
   PHY_DDR3_USER_DATA_IO_STD_ENUM                    : IO_STD_SSTL_15
   PHY_DDR3_USER_DATA_OUT_MODE_ENUM                  : OUT_OCT_34_CAL
   PHY_DDR3_USER_DATA_OUT_SLEW_RATE_ENUM             : unset
   PHY_DDR3_USER_DATA_OUT_DEEMPHASIS_ENUM            : unset
   PHY_DDR3_USER_DATA_IN_MODE_ENUM                   : IN_OCT_120_CAL
   PHY_DDR3_USER_AUTO_STARTING_VREFIN_EN             : true
   PHY_DDR3_USER_STARTING_VREFIN                     : 50.0
   ...
   PHY_DDR3_AC_DEEMPHASIS_ENUM                       : DEEMPHASIS_MODE_INVALID
   PHY_DDR3_CK_IO_STD_ENUM                           : IO_STD_SSTL_15_C1
   PHY_DDR3_CK_MODE_ENUM                             : CURRENT_ST_12
   PHY_DDR3_CK_SLEW_RATE_ENUM                        : SLEW_RATE_FAST
   PHY_DDR3_CK_DEEMPHASIS_ENUM                       : DEEMPHASIS_MODE_INVALID
   PHY_DDR3_DATA_IO_STD_ENUM                         : IO_STD_SSTL_15
   PHY_DDR3_DATA_OUT_MODE_ENUM                       : OUT_OCT_34_CAL
   PHY_DDR3_DATA_OUT_SLEW_RATE_ENUM                  : SLEW_RATE_INVALID
   PHY_DDR3_DATA_OUT_DEEMPHASIS_ENUM                 : DEEMPHASIS_MODE_INVALID
   PHY_DDR3_DATA_IN_MODE_ENUM                        : IN_OCT_120_CAL
   PHY_DDR3_AUTO_STARTING_VREFIN_EN                  : true
   PHY_DDR3_STARTING_VREFIN                          : 50.0
   ...
   PHY_DDR3_CAL_ENABLE_NON_DES                       : false
   MEM_FORMAT_ENUM                                   : MEM_FORMAT_DISCRETE
   MEM_READ_LATENCY                                  : 12.0
   ...
   MEM_TTL_DATA_WIDTH                                : 40
   MEM_TTL_NUM_OF_READ_GROUPS                        : 5
   MEM_TTL_NUM_OF_WRITE_GROUPS                       : 5
   MEM_DDR3_FORMAT_ENUM                              : MEM_FORMAT_DISCRETE
   MEM_DDR3_DQ_WIDTH                                 : 40
   ...
   MEM_DDR3_CK_WIDTH                                 : 1
   MEM_DDR3_ROW_ADDR_WIDTH                           : 13
   MEM_DDR3_COL_ADDR_WIDTH                           : 10
   MEM_DDR3_BANK_ADDR_WIDTH                          : 3
   MEM_DDR3_DM_EN                                    : true
   MEM_DDR3_DISCRETE_MIRROR_ADDRESSING_EN            : false
   ...
   MEM_DDR3_MR0                                      : 0xe04
   MEM_DDR3_MR1                                      : 0x10042
   MEM_DDR3_MR2                                      : 0x20028
   MEM_DDR3_MR3                                      : 0x30000
   ...
   MEM_DDR3_RTT_WR_ENUM                              : DDR3_RTT_WR_ODT_DISABLED
   MEM_DDR3_WTCL                                     : 10
   ...
   MEM_DDR3_R_ODT0_4X4                               : off off on off
   MEM_DDR3_R_ODT1_4X4                               : off off off on
   MEM_DDR3_R_ODT2_4X4                               : on off off off
   MEM_DDR3_R_ODT3_4X4                               : off on off off
   MEM_DDR3_W_ODTN_4X4                               : {Rank 0} {Rank 1} {Rank 2} {Rank 3}
   MEM_DDR3_W_ODT0_4X4                               : on off on off
   MEM_DDR3_W_ODT1_4X4                               : off on off on
   MEM_DDR3_W_ODT2_4X4                               : on off on off
   MEM_DDR3_W_ODT3_4X4                               : off on off on
   ...
   MEM_DDR3_TRFC_NS                                  : 110.0
   MEM_DDR3_TWR_NS                                   : 15.0
   MEM_DDR3_TWTR_CYC                                 : 4
   MEM_DDR3_TFAW_NS                                  : 35.0
   MEM_DDR3_TRRD_CYC                                 : 4
   MEM_DDR3_TRTP_CYC                                 : 4
   MEM_DDR3_TINIT_CK                                 : 466500
   MEM_DDR3_TDQSCK_DERV_PS                           : 2
   MEM_DDR3_TDQSCKDS                                 : 450
   MEM_DDR3_TDQSCKDM                                 : 900
   MEM_DDR3_TDQSCKDL                                 : 1200
   MEM_DDR3_TRAS_CYC                                 : 32
   MEM_DDR3_TRCD_CYC                                 : 13
   MEM_DDR3_TRP_CYC                                  : 13
   MEM_DDR3_TRFC_CYC                                 : 103
   MEM_DDR3_TWR_CYC                                  : 14
   MEM_DDR3_TFAW_CYC                                 : 33
   MEM_DDR3_TREFI_CYC                                : 7278
   ...
   BOARD_DDR3_SKEW_WITHIN_DQS_NS                     : 0.12000000000000001
   BOARD_DDR3_SKEW_WITHIN_AC_NS                      : 0.02
   CTRL_ECC_EN                                       : false
   CTRL_MMR_EN                                       : false
   ...
   CTRL_DDR3_ADDR_ORDER_ENUM                         : DDR3_CTRL_ADDR_ORDER_CS_B_R_C
   CTRL_DDR3_ECC_EN                                  : false
   CTRL_DDR3_ECC_AUTO_CORRECTION_EN                  : false
   CTRL_DDR3_ECC_READDATAERROR_EN                    : false
   CTRL_DDR3_ECC_STATUS_EN                           : false
   ...
   DIAG_DDR3_EXPORT_SEQ_AVALON_HEAD_OF_CHAIN         : true
   DIAG_DDR3_EX_DESIGN_NUM_OF_SLAVES                 : 1
   DIAG_DDR3_EX_DESIGN_ISSP_EN                       : true
   DIAG_DDR3_INTERFACE_ID                            : 0
   DIAG_DDR3_EFFICIENCY_MONITOR                      : EFFMON_MODE_DISABLED
   DIAG_DDR3_USE_NEW_EFFMON_S10                      : false
   DIAG_DDR3_USER_SIM_MEMORY_PRELOAD                 : false
   DIAG_DDR3_USER_SIM_MEMORY_PRELOAD_PRI_EMIF_FILE   : EMIF_PRI_PRELOAD.txt
   DIAG_DDR3_USER_SIM_MEMORY_PRELOAD_SEC_EMIF_FILE   : EMIF_SEC_PRELOAD.txt
   DIAG_DDR3_USER_USE_SIM_MEMORY_VALIDATION_TG       : true
   DIAG_DDR3_USE_TG_AVL_2                            : false
   DIAG_DDR3_USE_TG_HBM                              : false
   DIAG_DDR3_ABSTRACT_PHY                            : true
   DIAG_DDR3_ENABLE_DEFAULT_MODE                     : false
   DIAG_DDR3_ENABLE_USER_MODE                        : true
   DIAG_DDR3_EXPORT_TG_CFG_AVALON_SLAVE              : TG_CFG_AMM_EXPORT_MODE_JTAG
   DIAG_DDR3_TG2_TEST_DURATION                       : SHORT
   DIAG_DDR3_SEPARATE_READ_WRITE_ITFS                : false
   DIAG_DDR3_DISABLE_AFI_P2C_REGISTERS               : false
   DIAG_DDR3_AC_PARITY_ERR                           : false
   DIAG_DDR3_SIM_MEMORY_PRELOAD                      : false
   DIAG_DDR3_SIM_MEMORY_PRELOAD_PRI_EMIF_FILE        : 
   DIAG_DDR3_SIM_MEMORY_PRELOAD_SEC_EMIF_FILE        : 
   DIAG_DDR3_USE_SIM_MEMORY_VALIDATION_TG            : false
   DIAG_DDR3_EX_DESIGN_SEPARATE_RZQS                 : true
   DIAG_DDR3_SIM_VERBOSE                             : true
   DIAG_DDR3_CA_LEVEL_EN                             : false
   DIAG_DDR3_CA_DESKEW_EN                            : false
   DIAG_DDR3_CAL_ADDR0                               : 0
   DIAG_DDR3_CAL_ADDR1                               : 8
   DIAG_DDR3_CAL_ENABLE_NON_DES                      : false
   DIAG_DDR3_CAL_FULL_CAL_ON_RESET                   : true
   DIAG_DDR3_CAL_ENABLE_MICRON_AP                    : false
   NUM_IPS                                           : 1
   ...
   EX_DESIGN_GUI_DDR3_GEN_SIM                        : false
   EX_DESIGN_GUI_DDR3_GEN_SYNTH                      : false
   EX_DESIGN_GUI_DDR3_GEN_BSI                        : false
   EX_DESIGN_GUI_DDR3_GEN_CDC                        : false
