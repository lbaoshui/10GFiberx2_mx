...
source "$script_dir/ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_ip_parameters.tcl"
source "$script_dir/ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_parameters.tcl"
source "$script_dir/ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_pin_map.tcl"
...
set entity_names_on [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_are_entity_names_on ]
...
set pll_multiplier [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [expr $var(PHY_MEM_CLK_FREQ_MHZ)/$var(PHY_REF_CLK_FREQ_MHZ)] ]
set vco_multiplier [expr int($var(PHY_REF_CLK_FREQ_PS)/$var(PHY_VCO_FREQ_PS))]

# Half of memory clock cycle
set half_period [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr $var(UI) / 2.0 ] ]

# Half of reference clock
set ref_period      [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr $var(PHY_REF_CLK_FREQ_PS)/1000.0] ]
set ref_half_period [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr $ref_period / 2.0 ] ]

# Other clock periods
set tCK_AFI     [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr 1000.0/$var(PHY_MEM_CLK_FREQ_MHZ)*$var(USER_CLK_RATIO) ] ]
set tCK_C2P_P2C [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr 1000.0/$var(PHY_MEM_CLK_FREQ_MHZ)*$var(C2P_P2C_CLK_RATIO) ] ]
set tCK_PHY     [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr 1000.0/$var(PHY_MEM_CLK_FREQ_MHZ)*$var(PHY_HMC_CLK_RATIO) ] ]

# Asymmetric uncertainties on address and command paths
set ac_min_delay [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr - $var(tIH) + $var(CA_TO_CK_BD_PKG_SKEW) ]]
set ac_max_delay [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_round_3dp [ expr   $var(tIS) + $var(CA_TO_CK_BD_PKG_SKEW) ]]
...
if { ! [ info exists ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_sdc_cache ] } {
   ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_initialize_ddr_db ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_ddr_db var
   set ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_sdc_cache 1
} else {
   if { $debug } {
...
set instances [ array names ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_ddr_db ]
foreach { inst } $instances {
   if { [ info exists pins ] } {
      unset pins
   }
   array set pins $ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_ddr_db($inst)
   ...
   set ref_clock_exists [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_does_ref_clk_exist $pins(pll_ref_clock) ]
   ...
   set pins(ref_clock_name) [ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_clock_name_from_pin_name $pins(pll_ref_clock)]
   ...
   foreach { vco_clock } $pins(pll_vco_clock) {
      ...
      set local_pll_vco_clk_${i_vco_clock} [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
         -target $vco_clock \
   ...
   if {! $var(IS_HPS)} {
      ...
      set local_pll_master_vco_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
      ...
      if {$pins(master_core_usr_clock) != ""} {
         ...
         set local_core_usr_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
      ...
      if {$pins(master_core_usr_clock_sec) != ""} {
         ...
         set local_core_usr_clock_sec [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
      ...
      if {$pins(master_core_usr_half_clock) != ""} {
         ...
         set local_core_usr_half_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
            -target $master_core_clock \
            -name "${pins(master_instname)}_${name}" \
            -source $pins(master_vco_clock) \
            -multiply_by 1 \
      ...
      if {$pins(master_core_afi_clock) != ""} {
         ...
         set local_core_afi_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
            -target $master_core_clock \
            -name "${pins(master_instname)}_${name}" \
            -source $pins(master_vco_clock) \
            -multiply_by 1 \
      ...
      if {$pins(master_core_afi_half_clock) != ""} {
         ...
         set local_core_afi_half_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
            -target $master_core_clock \
            -name "${pins(master_instname)}_${name}" \
            -source $pins(master_vco_clock) \
            -multiply_by 1 \
      ...
      if {$pins(master_core_dft_cpa_1_clock) != ""} {
         ...
         set local_core_dft_cpa_1_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
            -target $master_core_clock \
            -name "${pins(master_instname)}_${name}" \
            -source $pins(master_vco_clock) \
            -multiply_by 1 \
      ...
      if {$pins(master_cal_master_clk) != ""} {
         ...
         if {[get_collection_size $pll_cal_master_clk] > 0} {
            ...
            set local_cal_master_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
               -target $master_core_clock \
               -name "${pins(master_instname)}_${name}" \
               -source $pins(master_vco_clock) \
               -multiply_by 1  \
      ...
      if {$pins(master_cal_slave_clk) != ""} {
         ...
         if {[get_collection_size $pll_cal_slave_clk] > 0} {
            ...
            set local_cal_slave_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
               -target $master_core_clock \
               -name "${pins(master_instname)}_${name}" \
               -source $pins(master_vco_clock) \
               -multiply_by 1  \
      ...
      if {$pins(usermode_oct_clock) != ""} {
         set local_core_usermode_oct_clock [ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
      ...
      if {$pins(usermode_oct_gated_clock) != ""} {
         set local_core_usermode_oct_gated_clock [ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
      ...
      for {set i_extra_clk 0} {$i_extra_clk < $var(PLL_NUM_OF_EXTRA_CLKS)} {incr i_extra_clk} {
         ...
         if {[get_collection_size $pll_extra_clk] > 0} {
            ...
            set local_pll_extra_clock [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
               -target $master_core_clock \
               -name "${pins(master_instname)}_${name}" \
               -source $pins(master_vco_clock) \
               -multiply_by 1  \
   ...
   foreach { phy_clock } $pins(pll_phy_clock) {
      ...
      set local_phy_clk_${i_phy_clock} [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
         -target $phy_clock \
   ...
   foreach { phy_clock_l } $pins(pll_phy_clock_l) {
      ...
      set local_phy_clk_l_${i_phy_clock_l} [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
         -target $phy_clock_l \
   ...
   foreach_in_collection wf_clock $write_fifo_clk {
      set vco_clock_id [ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_vco_clk_id $wf_clock var]
      if {$vco_clock_id == -1} {
         post_message -type critical_warning "Failed to find VCO clock"
      } else {
         set local_wf_clk_${i_wf_clock} [ ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_or_add_generated_clock \
   ...
   if {!$var(IS_HPS) && ($fit_flow == 1 || $sta_flow == 1)} {
      ...
      set p2c_c2p_multi_tile_clock_uncertainty [ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_p2c_c2p_clock_uncertainty $inst var]

      # Get extra periphery clock uncertainty
      set periphery_clock_uncertainty [list]
      ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_periphery_clock_uncertainty periphery_clock_uncertainty var

      # Get Fitter overconstraints
      if {$fit_flow == 1} {
         ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_periphery_overconstraints periphery_overconstraints_st periphery_overconstraints_mt var
      } else {
      ...
      ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_core_clock_uncertainty core_clock_uncertainty var

      # Get Fitter overconstraints
      if {$fit_flow == 1} {
         ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_get_core_overconstraints core_overconstraints var
      } else {
...
add_ddr_report_command "source [list [file join [file dirname [info script]] ${::GLOBAL_ed_synth_emif_0_altera_emif_arch_nf_181_iyqgzba_corename}_report_timing.tcl]]"
