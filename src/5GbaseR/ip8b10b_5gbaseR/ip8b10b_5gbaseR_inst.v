	ip8b10b_5gbaseR u0 (
		...
		.tx_pma_div_clkout       (_connected_to_tx_pma_div_clkout_),       //  output,    width = 4,       tx_pma_div_clkout.clk
		.rx_pma_div_clkout       (_connected_to_rx_pma_div_clkout_),       //  output,    width = 4,       rx_pma_div_clkout.clk
		.tx_parallel_data        (_connected_to_tx_parallel_data_),        //   input,  width = 256,        tx_parallel_data.tx_parallel_data
		.tx_control              (_connected_to_tx_control_),              //   input,   width = 32,              tx_control.tx_control
		.tx_err_ins              (_connected_to_tx_err_ins_),              //   input,    width = 4,              tx_err_ins.tx_err_ins
		.unused_tx_parallel_data (_connected_to_unused_tx_parallel_data_), //   input,  width = 256, unused_tx_parallel_data.unused_tx_parallel_data
		.unused_tx_control       (_connected_to_unused_tx_control_),       //   input,   width = 36,       unused_tx_control.unused_tx_control
		.rx_parallel_data        (_connected_to_rx_parallel_data_),        //  output,  width = 256,        rx_parallel_data.rx_parallel_data
		.rx_control              (_connected_to_rx_control_),              //  output,   width = 32,              rx_control.rx_control
		.unused_rx_parallel_data (_connected_to_unused_rx_parallel_data_), //  output,  width = 256, unused_rx_parallel_data.unused_rx_parallel_data
		.unused_rx_control       (_connected_to_unused_rx_control_),       //  output,   width = 48,       unused_rx_control.unused_rx_control
		.tx_enh_data_valid       (_connected_to_tx_enh_data_valid_),       //   input,    width = 4,       tx_enh_data_valid.tx_enh_data_valid
		.tx_enh_fifo_full        (_connected_to_tx_enh_fifo_full_),        //  output,    width = 4,        tx_enh_fifo_full.tx_enh_fifo_full
		.tx_enh_fifo_pfull       (_connected_to_tx_enh_fifo_pfull_),       //  output,    width = 4,       tx_enh_fifo_pfull.tx_enh_fifo_pfull
		.tx_enh_fifo_empty       (_connected_to_tx_enh_fifo_empty_),       //  output,    width = 4,       tx_enh_fifo_empty.tx_enh_fifo_empty
		.tx_enh_fifo_pempty      (_connected_to_tx_enh_fifo_pempty_),      //  output,    width = 4,      tx_enh_fifo_pempty.tx_enh_fifo_pempty
		.rx_enh_data_valid       (_connected_to_rx_enh_data_valid_),       //  output,    width = 4,       rx_enh_data_valid.rx_enh_data_valid
		.rx_enh_fifo_full        (_connected_to_rx_enh_fifo_full_),        //  output,    width = 4,        rx_enh_fifo_full.rx_enh_fifo_full
		.rx_enh_fifo_empty       (_connected_to_rx_enh_fifo_empty_),       //  output,    width = 4,       rx_enh_fifo_empty.rx_enh_fifo_empty
		.rx_enh_fifo_del         (_connected_to_rx_enh_fifo_del_),         //  output,    width = 4,         rx_enh_fifo_del.rx_enh_fifo_del
		.rx_enh_fifo_insert      (_connected_to_rx_enh_fifo_insert_),      //  output,    width = 4,      rx_enh_fifo_insert.rx_enh_fifo_insert
		.rx_enh_highber          (_connected_to_rx_enh_highber_),          //  output,    width = 4,          rx_enh_highber.rx_enh_highber
		...
		.reconfig_address        (_connected_to_reconfig_address_),        //   input,   width = 12,                        .address
