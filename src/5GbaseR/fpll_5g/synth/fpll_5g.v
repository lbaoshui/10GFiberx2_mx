...
module fpll_5g (
	...
	altera_xcvr_fpll_a10 #(
		...
		.cmu_fpll_m_counter                                                           (33),
		.cmu_fpll_n_counter                                                           (1),
		.cmu_fpll_out_freq_hz                                                         ("0 hz"),
		.cmu_fpll_out_freq                                                            ("000010011001101010110001000011001000"),
		...
		.cmu_fpll_vco_freq_hz                                                         ("10312500000"),
		.cmu_fpll_vco_freq                                                            ("001001100110101011000100001100100000"),
		.cmu_fpll_pll_bw_mode                                                         ("low_bw"),
		.cmu_fpll_datarate                                                            ("5156250000 bps"),
		...
		.cmu_fpll_hssi_output_clock_frequency                                         ("2578.125 MHz"),
		...
		.cmu_fpll_reference_clock_frequency                                           ("156.25 MHz"),
		.cmu_fpll_vco_frequency                                                       ("10312.5 MHz"),
		.cmu_fpll_cgb_div                                                             (1),
		...
		.cmu_fpll_pfd_freq                                                            ("000000001001010100000010111110010000"),
		...
		.cmu_fpll_refclk_freq                                                         ("000000001001010100000010111110010000"),
		.enable_mcgb                                                                  (0),
		...
		.hssi_pma_cgb_master_datarate                                                 ("5156250000 bps"),
